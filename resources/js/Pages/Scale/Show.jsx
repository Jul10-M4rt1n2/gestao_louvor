...
export default function Show({ schedule, scheduleMusics, participants, availableMusics, availableUsers }) {
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-2 ml-4">
                                                    <select
                                                        ...
                                                        onChange={(e) => handleUpdateParticipantStatus(participant.user_id, e.target.value)}
                                    ...
                                    <form onSubmit={handleAddParticipant} className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                id="function"
                                                value={participantData.function}
                                                onChange={(e) => setParticipantData('function', e.target.value)}
                                                placeholder="Ex: Vocalista, Guitarrista, Bateria..."
                                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                                required
                                            />
                                        </div>
